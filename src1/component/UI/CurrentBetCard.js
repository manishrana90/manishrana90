...
const CurrentBetCard = ({ item }) => {
  ...
  return (
    <TouchableOpacity
      onPress={() =>
        navigation.navigate(
          item.eventId === "1234822733" ? "Live" : "LiveBet",
          {
        ...
        <View style={styles.innerDetailBetCardViewUpper}>
          <View style={styles.innerbetNameCardView}>
            <Text style={styles.innerbetNameText}>
              {item.eventTypeName === "Casino" ? item.gameId : item.eventName}
            </Text>
