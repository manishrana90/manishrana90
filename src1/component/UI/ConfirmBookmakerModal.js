  ...
  const placeBet = async () => {
    ...
    batch(() => {
      ...
      dispatch({
        type: "COUNT",
        payload:
          betAllData.eventTypeId === "v9"
            ? (virtualTime / 1000).toFixed(0)
            : betAllData.eventTypeId === "b9"
            ? (bbbTime / 1000).toFixed(0)
            : betAllData.eventTypeId === "2"
            ? (tennisTime / 1000).toFixed(0)
            : betAllData.eventTypeId === "1"
            ? (soccerTime / 1000).toFixed(0)
            : betAllData.marketType === "Bookmaker" || betAllData.marketType === "Toss"
            ? (bookmakerTime / 1000).toFixed(0)
            : betAllData.marketType === "Special"
            ? (bookmakerTime / 1000).toFixed(0)
            : (cricketTime / 1000).toFixed(0),
      });
      dispatch({
        type: "PLACETYPE",
        payload: "bet",
...
export default ConfirmBookmakerModal;
